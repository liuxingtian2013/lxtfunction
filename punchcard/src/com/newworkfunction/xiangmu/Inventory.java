...
public class Inventory extends Activity implements OnFooterRefreshListener,OnHeaderRefreshListener{
	PullToRefreshView mPullToRefreshView;
	private ListView lv;
	private Timer timer;
	private Listviewinventoryadapter  adapter;
...
//		getcaigoujihualist();
	...
	private void initview() {
		...
		adapter  = new Listviewinventoryadapter(getApplicationContext());
		lv.setAdapter(adapter);
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		fanhuiib = (ImageButton) findViewById(R.id.inventoryfanhuiib);
		...
		xinjianib = (ImageButton) findViewById(R.id.inventory);
		...
		shuaxin = (LinearLayout) findViewById(R.id.shuaxinyemian_inventory);
