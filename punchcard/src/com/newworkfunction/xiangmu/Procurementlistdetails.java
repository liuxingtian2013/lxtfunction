...
import com.example.Adapter.Listviewcaigouqingdandetailsadapter;
...
public class Procurementlistdetails extends Activity implements OnFooterRefreshListener,OnHeaderRefreshListener{
	PullToRefreshView mPullToRefreshView;
	private ListView lv;
	private Listviewcaigouqingdandetailsadapter  adapter;
	public static int currentpage=1;//当前页
	private EditText num_pop,unitprice_pop,remark_pop;
	JSONObject json;
	private View root;
	private TextView cancelpop,savepop;
	...
	private void initview() {
		...
		lv = (ListView) findViewById(R.id.caigouqingdanxiangqingListView);
		adapter  = new Listviewcaigouqingdandetailsadapter(getApplicationContext());
		Toast.makeText(getApplicationContext(), "!点击各项进行操作", Toast.LENGTH_LONG).show();
		lv.setAdapter(adapter);
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		fanhuiib = (ImageButton) findViewById(R.id.caigouqingdanxiangqingfanhuiib);
		fanhuiib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Procurementlistdetails.this.finish();
			}
		});
		xinjianib = (ImageButton) findViewById(R.id.xinjiancaigouxiangqingqingdan);
		...
		shuaxin = (LinearLayout) findViewById(R.id.shuaxinyemian_caigouqingdanxiangqing);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, final View view , int position,long id) {
				...
				cancelpop.setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						if (popupWindow.isShowing())
						popupWindow.dismiss();
						num_pop.setText("");
						unitprice_pop.setText("");
						remark_pop.setText("");
					}
				});
				savepop.setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						if (popupWindow.isShowing())
							popupWindow.dismiss();
						TextView tv =(TextView) view.findViewById(R.id.Alreadybought_tv);
						tv.setTextColor(getResources().getColor(R.color.rgb_33ff00));
					}
				});
			}
		});
	...
	public void initPopupWindow() {
		...
		num_pop = (EditText) contentView.findViewById(R.id.num_pop);
		unitprice_pop = (EditText) contentView.findViewById(R.id.unitprice_pop);
		remark_pop = (EditText) contentView.findViewById(R.id.remark_pop);
		 cancelpop = (TextView)contentView.findViewById(R.id.cancel_pop);
		 savepop = (TextView)contentView.findViewById(R.id.save_pop);
		// 全屏显示，将内容设置在底部
