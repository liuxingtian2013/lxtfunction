...
public class Procurementplan extends Activity implements OnFooterRefreshListener,OnHeaderRefreshListener{
	PullToRefreshView mPullToRefreshView;
	private ListView lv;
	private Timer timer;
	private Listviewcaigoujihuaadapter  adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.procurementplan);
		initview();
//		getcaigoujihualist();
	}
	...
	private void initview() {
		...
		lv = (ListView) findViewById(R.id.caigoujihuaListView);
		adapter  = new Listviewcaigoujihuaadapter(getApplicationContext());
		lv.setAdapter(adapter);
		Toast.makeText(getApplicationContext(), "! 长按各项可进行操作", Toast.LENGTH_LONG).show();
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		fanhuiib = (ImageButton) findViewById(R.id.caigoujihuafanhuiib);
		fanhuiib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Procurementplan.this.finish();
			}
		});
		xinjianib = (ImageButton) findViewById(R.id.xinjiancaigoujihua);
		...
		shuaxin = (LinearLayout) findViewById(R.id.shuaxinyemian_caigoujihua);
...
//				getcaigoujihualist();
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,long id) {
				...
				intent.putExtra("caigoujihuaid", position );
				intent.setClass(getApplicationContext(), Procurementplandetails.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {  
       Toast.makeText(getApplicationContext(), "点击了长按菜单里面的第"+item.getItemId()+"个项目", Toast.LENGTH_SHORT).show();
