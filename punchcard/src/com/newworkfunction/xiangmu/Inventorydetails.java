...
import com.example.Adapter.Inventorydetailsadapter;
...
import com.example.Adapter.Listviewinventoryadapter;
...
public class Inventorydetails extends Activity implements OnFooterRefreshListener,OnHeaderRefreshListener{
...
//		getcaigoujihualist();
	...
	private void initview() {
		...
		lv = (ListView) findViewById(R.id.inventorydetailsListView);
		adapter  = new Inventorydetailsadapter(getApplicationContext());
		lv.setAdapter(adapter);
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		fanhuiib = (ImageButton) findViewById(R.id.inventorydetailsfanhuiib);
		fanhuiib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Inventorydetails.this.finish();
			}
		});
		xinjianib = (ImageButton) findViewById(R.id.inventorydetails);
		...
		shuaxin = (LinearLayout) findViewById(R.id.shuaxinyemian_inventorydetails);
...
//				intent.setClass(getApplicationContext(),Inventorydetails.class);
