...
import com.example.Adapter.Listviewcaigoujihuadetailsadapter;
...
public class Procurementplandetails extends Activity implements OnFooterRefreshListener,OnHeaderRefreshListener{
	PullToRefreshView mPullToRefreshView;
	private ListView lv;
	private Timer timer;
	private Listviewcaigoujihuadetailsadapter  adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.procurementplandetails);
		initview();
//		getcaigoujihualist();
	}
	...
	private void initview() {
		...
		lv = (ListView) findViewById(R.id.caigoujihuaxiangqingListView);
		adapter  = new Listviewcaigoujihuadetailsadapter(getApplicationContext());
		lv.setAdapter(adapter);
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		fanhuiib = (ImageButton) findViewById(R.id.caigoujihuaxiangqingfanhuiib);
		fanhuiib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Procurementplandetails.this.finish();
			}
		});
		xinjianib = (ImageButton) findViewById(R.id.xinjiancaigouxiangqingjihua);
		...
		shuaxin = (LinearLayout) findViewById(R.id.shuaxinyemian_caigoujihuaxiangqing);
