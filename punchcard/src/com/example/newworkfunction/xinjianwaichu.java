...
public class xinjianwaichu extends Activity{
	private EditText startDateTime,endDateTime,waichushiyou,gongzuojiaojie;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xinjianwaichu);
		ImageButton ib = (ImageButton) findViewById(R.id.xinjinawaichushenqingshuaxin_ib);
		...
		// 两个输入框
		startDateTime = (EditText) findViewById(R.id.xinjianwaichu_qishishijian_et);
		endDateTime = (EditText) findViewById(R.id.xinjianwaichu_zhongzhishijian_et);
		waichushiyou = (EditText) findViewById(R.id.xinjianwaichu_waichushiyou_et);
		gongzuojiaojie = (EditText) findViewById(R.id.xinjianwaichu_gongzuojiaojie_et);
		button = (Button) findViewById(R.id.xinjianwaichu_tijiao_button);
		//提交外出申请按钮监听
			...
			public void onClick(View v) {
				if(dateTimePicKDialog==null){
				 dateTimePicKDialog = new DateTimePickDialogUtil(
						xinjianwaichu.this, initEndDateTime);
		...
		post();
		tv = (TextView) findViewById(R.id.xinjianwaichu_xuanxiang_tv);
		spinner = (Spinner) findViewById(R.id.xinjianwaichu_spinner);
	...
	public void post(){
		...
		params.add(new BasicNameValuePair("type","51"));
//		params.add(new BasicNameValuePair("id","0"));
	...
	public void postwaichushenqing() {
		...
		progressDialog = ProgressDialog.show(xinjianwaichu.this, "请稍等...","提交申请中...", true);
		progressDialog.setCancelable(true);
		String startTime = startDateTime.getText().toString();
		String endTime = endDateTime.getText().toString();
		String shiyou = waichushiyou.getText().toString();
		String jiaojie =gongzuojiaojie.getText().toString();
		String waichutype = tv.getText().toString();
		final List<NameValuePair> params = new ArrayList<NameValuePair>();
		...
		params.add(new BasicNameValuePair("txtLeaveType","2"));
		XRequest request = new XRequest();
