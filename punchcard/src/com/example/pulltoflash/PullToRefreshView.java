package com.example.pulltoflash;
...
public class PullToRefreshView extends LinearLayout {
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderState = PULL_TO_REFRESH;
		setLastUpdated("上一次更新时间为:" +  DateFormat.format("   yyyy-MM-dd hh:mm:ss   ", System.currentTimeMillis()));
	}
...
//			mHeaderUpdateTextView.setTextSize(15);
		} else {
