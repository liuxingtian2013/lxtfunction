...
public class Listviewzhiduadapter extends BaseAdapter{
	...
	public Listviewzhiduadapter(Context mContext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView==null){
			convertView = LayoutInflater.from(mContext).inflate(R.layout.zhiduitem, parent,false);
		}
		TextView tv = (TextView) convertView.findViewById(R.id.tv_zhiduitem_sign);
		TextView tv1 = (TextView) convertView.findViewById(R.id.tv_zhiduitem_text);
		TextView tv2 = (TextView) convertView.findViewById(R.id.tv_zhiduitem_time);
